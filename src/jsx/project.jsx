...
export default function Project() {
    ...
    const fetchData = async () => {
        const projectUrl = "https://api.sheety.co/5051b16289978df7d01b327c7ffe79e3/portFolioApi/project"
    ...
    return (
        <div>
            ...
            <div className="project-all-container">
                {project?.slice(0,numProject).map(res => (
                    <a href={res.githubLink} target="_blank" className="project-github-link">
                        <div className="project-container">
                            ...
                            <div className="project-text-container">
                                ...
                                <p className="project-description">{res.description.substring(0,250)}</p>
                            </div>
                        </div>
                    </a>
                ))}
