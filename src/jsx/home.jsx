...
export default function Home() {
    ...
    const fetchCV = async () => {
        const cvUrl = "https://api.sheety.co/5051b16289978df7d01b327c7ffe79e3/portFolioApi/cv"
    ...
    return(
        <div className="background-container">
            ...
            <div className="introduce-words" id="home">
                ...
                <h2 className="introduce-words-doing"> I'm interested in
            ...
            <section className="home-aboutme" id="aboutme">
                ...
                <div className="home-aboutme-all-text-container">
                    <div className="home-aboutme-text-container">
                        ...
                        <div className="home-about-me-button-container">
                            <Link to="/aboutme" className="home-aboutme-link" id="about-me-link">
                                <button className="home-aboutme-button">MORE ABOUT ME</button>
                            </Link>
                            {cv?.map(res => (
                                <a href={res.name} target="_blank">
                                    <button className="home-aboutme-button" id="download-cv">DOWNLOAD CV</button>
                                </a>
                            ))}
                        </div>
                    </div>
                ...
                <div className="home-aboutme-myimage" 
                    style={{backgroundImage: `url("./image/myPhoto.HEIC")`}}>
                </div>
            ...
            <section className="home-project" id="project">
                ...
                <div className="home-project-all-container">
                    {project?.slice(0,6).map(res => (
                        <a href={res.githubLink} target="_blank" className="home-project-github-link">
                            <div className="home-project-container">
                                ...
                                <div className="home-project-text-container">
                                    ...
                                    <p className="home-project-description">{res.description.substring(0,250)}</p>
                                </div>
                            </div>
                        </a>
                    ))}
